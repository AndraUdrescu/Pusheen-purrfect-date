...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "Quiz", "com.sample.quiz", "1.0.0");
		...
		telemetryConfig.app_name = "Purrrfect Date";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Purrrfect Date", null, { width: 800, height: 600 });
